...
public class ShootGame extends JPanel {
    ...
    static{ //初始化静态图片
        try{
           // background =  (BufferedImage)GameUtil.getImage("src/com/airplane/background.png");
            String basePath = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/background.png").getPath();
            basePath= URLDecoder.decode(basePath,"utf-8");
            background = ImageIO.read(new File(basePath));

            String basePath1 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/start.png").getPath();
            basePath1= URLDecoder.decode(basePath1,"utf-8");
            start = ImageIO.read(new File(basePath1));

            String basePath2 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/pause.png").getPath();
            basePath2= URLDecoder.decode(basePath2,"utf-8");
            pause = ImageIO.read(new File(basePath2));
            //pause = ImageIO.read(ShootGame.class.getResource("pause.png"));

            String basePath3 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/gameover.png").getPath();
            basePath3= URLDecoder.decode(basePath3,"utf-8");
            gameover = ImageIO.read(new File(basePath3));
            //gameover = ImageIO.read(ShootGame.class.getResource("gameover.png"));

            String basePath4 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/airplane.png").getPath();
            basePath4= URLDecoder.decode(basePath4,"utf-8");
            airplane = ImageIO.read(new File(basePath4));
            //airplane = ImageIO.read(ShootGame.class.getResource("airplane.png"));

            String basePath5 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/bee.png").getPath();
            basePath5= URLDecoder.decode(basePath5,"utf-8");
            bee = ImageIO.read(new File(basePath5));
            //bee = ImageIO.read(ShootGame.class.getResource("bee.png"));

            String basePath6 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/bullet.png").getPath();
            basePath6= URLDecoder.decode(basePath6,"utf-8");
            bullet = ImageIO.read(new File(basePath6));
            //bullet = ImageIO.read(ShootGame.class.getResource("bullet.png"));

            String basePath7 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/hero0.png").getPath();
            basePath7= URLDecoder.decode(basePath7,"utf-8");
            hero0 = ImageIO.read(new File(basePath7));
            //hero0 = ImageIO.read(ShootGame.class.getResource("hero0.png"));

            String basePath8 = Thread.currentThread().getContextClassLoader().getResource("com/airplane/image/hero1.png").getPath();
            basePath8= URLDecoder.decode(basePath8,"utf-8");
            hero1 = ImageIO.read(new File(basePath8));
    ...
    public FlyingObject nextOne(){
        ...
        int type = rand.nextInt(100); //0到19之间的随机数
